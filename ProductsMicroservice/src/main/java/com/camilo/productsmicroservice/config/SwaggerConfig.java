...
public class SwaggerConfig {
    ...
    public static final ApiInfo DEFAULT = new ApiInfo("Api Documentation for NTT DATA",
            "This module is in charge of CRUD operations for products", "1.0", "urn:tos", DEFAULT_CONTACT,
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(DEFAULT).produces(DEFAULT_PRODUCES)
                .select()
                .apis(RequestHandlerSelectors.basePackage( "com.camilo.productsmicroservice.controllers" ) )
